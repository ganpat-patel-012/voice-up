                        ...
                        <div class="card-body">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    ...
                                    <div class="text-uppercase text-primary font-weight-bold text-xs mb-1" style="width: 300px;"><span class="text-capitalize text-center" style="font-size: 25px;color: rgb(1,5,15);">&nbsp; &nbsp; Citizens :
                                            <?php
                                    ...
                                    <div class="text-dark font-weight-bold h5 mb-0" style="width: 290px;">
                                        <a href="managecitizens.php"><button class="btn btn-primary" type="button" style="background-color: rgb(52,57,72);margin-left: 10px; width: 250px;">Manage Citizens</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center no-gutters">
                                <div class="col mr-2">
                                    ...
                                    <div class="text-uppercase text-primary font-weight-bold text-xs mb-1" style="width: 300px;"><span class="text-capitalize text-center" style="font-size: 25px;color: rgb(1,5,15);">&nbsp; &nbsp; Agencies :
                                            <?php
                                    ...
                                    <div class="text-dark font-weight-bold h5 mb-0" style="width: 290px;">
                                        <a href="manageagencies.php"><button class="btn btn-primary" type="button" style="background-color: rgb(52,57,72);margin-left: 10px; width: 250px;">Manage Government Agencies</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
