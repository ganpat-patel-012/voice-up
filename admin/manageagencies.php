...
<body id="page-top">
    ...
    <table id="tabledata" class=" table table-striped table-hover table-bordered">
        ...
        $q = "select d_id, d_type, d_mobile, d_city, d_approve, d_photo from dept ORDER BY d_id DESC";
        ...
        ?>
            <tr class="text-center">
                ...
                <td data-label="Photo"> <img src="../dept/<?php echo $res['d_photo'];  ?>" width="50" height="60"> </td>
