...
<body id="page-top">
    ...
    <div class="login-clean" style="padding: 0px; background: rgb(255,255,255);margin-top: 30px; ">
        <form method="post" action="signup-script.php" enctype="multipart/form-data" style="background: #1A4E85;margin-bottom: 40px;">
            ...
            <div class="form-group"><input class="form-control" id="user_aadhar" type="text" name="user_aadhar" pattern="^[2-9]{1}[0-9]{11}$" title="Enter 12 digit Aadhar Number (Ex. 2345678382XX)" placeholder="Your Aadhar Number" required="" autofocus=""></div>

            <h5 style="color:#fff;">Aadhar PDF</h5>
            <div class="form-group"><input class="form-control" id="user_aadharpdf" type="file" accept="application/pdf" name="user_aadharpdf" required="" autofocus=""></div>
			
			 <h5 style="color:#fff;">Photo</h5>
            <div class="form-group"><input class="form-control" id="user_photo" type="file" accept="image/jpeg, image/jpg, image/png" name="user_photo" placeholder="Your Passport Size Photo" required="" autofocus=""></div>
