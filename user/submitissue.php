...
<body id="page-top">
    ...
    <div class="login-clean" style="padding: 0px;background: rgb(255,255,255);margin-top: 30px;">
        <form method="post" action="submitissue-script.php" enctype="multipart/form-data"
            ...
            <h5 style="color:#fff;">Issue Type</h5>
            <div class="form-group"> <select class="form-control" id="i_privacy" name="i_privacy" required>
            ...
            <h5 style="color:#fff;">Issue Summary</h5>
            <div class="form-group"><textarea class="form-control" id="i_sum" type="text" name="i_sum"
                    placeholder="Summary of Problem" required="" autofocus=""></textarea></div>
            ...
            <div class="form-group"><input class="form-control" id="i_img1" type="file"
                    accept="image/jpeg, image/jpg, image/png" name="i_img1" placeholder="Select Image" required=""
                    autofocus=""></div>

            <h5 style="color:#fff;">Image - 02</h5>
            <div class="form-group"><input class="form-control" id="i_img2" type="file"
                    accept="image/jpeg, image/jpg, image/png" name="i_img2" placeholder="Select Image" required=""
                    autofocus=""></div>

            <h5 style="color:#fff;">Image - 03</h5>
            <div class="form-group"><input class="form-control" id="i_img3" type="file"
                    accept="image/jpeg, image/jpg, image/png" name="i_img3" placeholder="Select Image" required=""
                    autofocus=""></div>
