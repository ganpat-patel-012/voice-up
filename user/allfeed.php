...
<body id="page-top">
    ...
    if ($u_approve == 2) { ?>
        ...
        <div class="features-boxed" style="background: #ffffff;">
            <div class="container" style="background: #ffffff;">
                <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                    <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">All Feed</h2>
                </div>
            </div>
        </div>
        ...
        $count = $con->query("SELECT * from issue i,user u  where u.u_id=i.i_u_id and i_privacy='Public' and u_mobile!=$u_mobile and i.i_status=0")->num_rows;
        if($count==0){ ?>
        ...
        $q = "SELECT * from issue i,user u  where u.u_id=i.i_u_id and i_privacy='Public' and u_mobile!=$u_mobile and i.i_status=0";
                    ...
                    <div class="post-content">
                        ...
                        ?>
                                            ...
                                            ?>
                                                ...
                                                <a href="downvoteall.php?u_mobile=<?php echo $u_mobile?>&&i_id=<?php echo $res['i_id'];  ?>"><img src="../assets/img/down.png" style="width:35px;height:35px;margin-left:10px;"></a>
                                                <h5 style="display:inline; margin-left:55px;"><?php echo $res['i_downvote'];  ?></h5>
                                                <a href="removevoteall.php?u_mobile=<?php echo $u_mobile?>&&i_id=<?php echo $res['i_id'];  ?>"><img src="../assets/img/remove.png" style="width:35px;height:35px;margin-left:10px;"></a>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div style="display:block; padding-top:20px;padding-bottom:20px;">
                                                <a href="upvoteall.php?u_mobile=<?php echo $u_mobile?>&&i_id=<?php echo $res['i_id'];  ?>"><img src="../assets/img/up.png" style="width:35px;height:35px;margin-left:0px;"></a>
                                                <h5 style="display:inline; margin-left:40px; padding:5px;"><?php echo $res['i_upvote'];  ?></h5>
