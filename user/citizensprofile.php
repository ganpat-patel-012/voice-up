    ...
    <nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav" style="background: #1A4E85;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" data-bs-hover-animate="pulse" href="../user/areafeed.php">DASHBOARD</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" data-bs-hover-animate="pulse" href="../user/allfeed.php">All Feed</a></li>
        ...
        while ($res = mysqli_fetch_assoc($result)) {
            ...
            $u_aadhar =  $res['u_aadhar'];
            $u_aadharpdf =  $res['u_aadharpdf'];
            $u_photo =  $res['u_photo'];
                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-md-4 bg-c-lite-green user-profile" >
                                <div class="card-block text-center text-white">
                                    <div class="m-b-25"> <img src="../user/<?php echo  $u_photo; ?>" width="200" height="240" align="center" class="img-radius" alt="User-Profile-Image"> </div>
                                    <h3 class="f-w-600"><?php echo "$u_name" ?></h3>
                                    <h5>Citizen</h5>
                                    <h5>Status: <?php if ($u_approve == "1") {
                                                    echo "No Action";
                                                } else if ($u_approve == "2") {
                                                    echo " Accepted";
                                                } else if ($u_approve == "3") {
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 class="text-muted  f-w-400"><?php echo "$u_aadhar" ?> &nbsp; <button class="btn btn-grey text-monospace"><a href="../user/<?php echo  $u_aadharpdf; ?>" target="_blank">View Aadhar</a></button></h6>
                                        </div>
                                    </div>
