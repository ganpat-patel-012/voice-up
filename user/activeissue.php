                    ...
                    <div class="post-content">
                        ...
                        ?>
                                            ...
                                            ?>
                                                ...
                                                <a href="downvoteactive.php?u_mobile=<?php echo $u_mobile?>&&i_id=<?php echo $res['i_id'];  ?>"><img src="../assets/img/down.png" style="width:35px;height:35px;margin-left:10px;"></a>
                                                <h5 style="display:inline; margin-left:55px;"><?php echo $res['i_downvote'];  ?></h5>
                                                <a href="removevoteactive.php?u_mobile=<?php echo $u_mobile?>&&i_id=<?php echo $res['i_id'];  ?>"><img src="../assets/img/remove.png" style="width:35px;height:35px;margin-left:10px;"></a>
                                                </div>
                                            <?php
                                            }
                                            ...
                                            ?>
                                                <div style="display:block; padding-top:20px;padding-bottom:20px;">
                                                <a href="upvoteactive.php?u_mobile=<?php echo $u_mobile?>&&i_id=<?php echo $res['i_id'];  ?>"><img src="../assets/img/up.png" style="width:35px;height:35px;margin-left:0px;"></a>
                                                <h5 style="display:inline; margin-left:40px; padding:5px;"><?php echo $res['i_upvote'];  ?></h5>
