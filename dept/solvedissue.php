...
<body id="page-top">
    ...
    if ($d_approve == 2) { ?>
        ...
        $count = $con->query("select * from issue i,user u, dept d where i.i_type='$d_type' and d.d_mobile=".$d_mobile." and u.u_id=i.i_u_id and i.i_status=1")->num_rows;
        if($count==0){ ?>
        ...
        $q = "select * from issue i,user u, dept d where i.i_type='$d_type' and d.d_mobile=".$d_mobile." and u.u_id=i.i_u_id and i.i_status=1";
