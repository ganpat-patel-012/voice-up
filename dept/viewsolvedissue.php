        ...
        <nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav" style="background: #1A4E85;">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" data-bs-hover-animate="pulse" href="areafeed.php">Public Feed</a></li>
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" data-bs-hover-animate="pulse" href="areafeed.php">Personal Feed</a></li>
       ...
       <?php
        ...
        <div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 cust_blogteaser" data-bs-hover-animate="bounce" style="padding-bottom:20px;margin-bottom:32px;"><a href="#"><img class="img-fluid" style="width:100%;" src="../user/<?php echo   $i_img1;?>"></a>

                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 cust_blogteaser" style="padding-bottom:20px;margin-bottom:32px;"><a href="#"><img class="img-fluid" data-bs-hover-animate="bounce" style="width:100%;" src="../user/<?php echo  $i_img2; ?>"></a>
                        <a class="h4" href="#"></a>
                    </div>
                    <div class=" col-lg-4 col-md-12 col-sm-12 col-xs-12 cust_blogteaser" style="padding-bottom:20px;margin-bottom:32px;"><a href="#"><img class="img-fluid" data-bs-hover-animate="bounce" style="width:100%;" src="../user/<?php echo  $i_img3; ?>"></a>
                        <a class="h4" href="#"></a>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12 col-md-12 col">
                                    <div class="card-block">
                                        ...
                                        <div class="row">
											...
											<div class="col-sm-6">
                                                <p class="m-b-10 f-w-600" style="color: #000;">Privacy</p>
                                                <h6 class="text-muted f-w-400"><?php echo "$i_privacy" ?></h6>
                                            </div>
										</div>
                                        <br>
