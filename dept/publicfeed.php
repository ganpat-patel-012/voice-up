...
<body id="page-top">
    ...
    if ($d_approve == 2) { ?>
        ...
        <div class="features-boxed " style="background: #ffffff;>
            <div class="container" style="background: #ffffff;">
                <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                    <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">Public Feed</h2>
                </div>
            </div>
        </div>
        ...
        $count = $con->query("SELECT * from issue i, user u where i.i_type='$d_type' and u.u_id=i.i_u_id and u.u_pincode=$d_pincode and i.i_status=0 and i_privacy='Public' ")->num_rows;
        if($count==0){ ?>
        ...
        <?php
        $q = "SELECT * from issue i, user u where i.i_type='$d_type' and u.u_id=i.i_u_id and u.u_pincode=$d_pincode and i.i_status=0 and i_privacy='Public' ";
