...
<body id="page-top">
    ...
    if ($d_approve == 2) { ?>
        ...
        $count = $con->query("SELECT * from issue i, user u where i.i_type='$d_type' and u.u_id=i.i_u_id and u.u_pincode=$d_pincode and i.i_status=0")->num_rows;
        if($count==0){ ?>
        ...
        <?php
        $q = "SELECT * from issue i, user u where i.i_type='$d_type' and u.u_id=i.i_u_id and u.u_pincode=$d_pincode and i.i_status=0";
