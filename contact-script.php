...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT into contactus(c_name,c_mobile,c_email,c_address,c_subject,c_message) VALUES('$user_name','$user_mobile','$user_email','$user_address','$user_subject','$user_message')";
